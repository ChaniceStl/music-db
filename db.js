...
//be sure to edit to change 'Chanice' to your specific username
//'music-db' is the name of the database
const sequelizeConnection = new Sequelize('postgres://Chanice@localhost:5432/music-db');
